...
$table2 = "SELECT * FROM member_time_in_logs WHERE isDeleted='0' AND member_timein='0' AND member_timeout='1'";
...
Would you like to timeout this user ? 
                ...
                <input type='hidden' name='get_timein' value='".$row['member_time_in_logs_id']."'>
                    <button type='submit' name='member_timein_logs'  class='btn btn-success'>Yes</button>
