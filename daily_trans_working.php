...
$table2 = "SELECT * FROM customer_daily WHERE isDeleted = '0' AND isTimeOut = '0' ORDER BY cust_lastname ASC";
...
"
 ...
 <form  role='form' action='save_data.php' method='post' >
    ...
    <div class='form-group'>
      <h3>Would you like to time out?</h3>
    </div>
                </div>
...
"
 ...
 <form  role='form' action='save_data.php' method='post' >
    <div class='form-group'>
Would you like to pauy this user ? 
