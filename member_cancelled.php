...
<div class="container">
<h2><B>&nbsp;CANCELLED MEMBERSHIP</B></h2>
<br>
<div class="col-md-12">
...
$table2 = "SELECT member.member_id,member.member_code,member.member_firstname,member.member_middlename,member.member_lastname,member.member_birthdate,member.member_address,member.member_gender,member.member_occupation,member.member_contact,member.member_sub_id,member.member_age,member.membership_registered,member.membership_expired,member_cancelled.date_cancelled
FROM member
RIGHT JOIN member_cancelled ON member.member_id=member_cancelled.member_id WHERE member.isDeleted = '0' and member.isExpired= '0' AND member.isCancelled = '1'";
...
echo"
    <div class='form-group'>
                ...
                <div class='modal-footer'>
                    ...
                    <button type='submit' name='member_renew'  class='btn btn-success'>Yes</button>
